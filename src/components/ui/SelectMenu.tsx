...
/* A menu row. The ink is stated only while the row is not the checked one: the checked pair is
   declared once, outside this component, and a utility here would beat it in every menu. */
const ITEM = "select-menu-item relative flex min-w-0 min-h-8 items-center rounded-control pr-7.5 pl-3 outline-0 select-none [corner-shape:round] not-data-[state=checked]:text-on-instrument-muted data-[highlighted]:not-data-[state=checked]:bg-instrument-hover data-[highlighted]:not-data-[state=checked]:text-on-instrument";
