...
const OVERLAY_PANEL = `fixed inset-0 z-scrim-content m-auto h-fit max-h-calendar-panel-height w-calendar-panel-width text-ink animate-calendar-modal-in motion-reduce:animate-none ${WINDOW}`;
...
function OverlayScrim({ onClose }: { onClose(): void }) {
