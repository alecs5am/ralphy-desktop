  ...
  return <div className="overview-dashboard">
    <section className="overview-card overview-state-card">
      ...
      <div className="overview-card-body">
        ...
        <dl className="overview-inline-facts"><div><dt>Current iteration</dt><dd>{activeIteration?.title ?? "None active"}</dd></div><div><dt>Updated</dt><dd>{formatTime(value.project.updatedAt)}</dd></div></dl>
