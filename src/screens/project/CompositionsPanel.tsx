    ...
    <section className="composition-detail" aria-label="Composition detail" ref={bindDetail} onScroll={detailScroll.onScroll}>
      ...
      {composition && <>
        ...
        {revision && <div className="composition-revision-detail">
          ...
          <section className="composition-output-section"><h5>Output preview</h5><div className="composition-output-preview" aria-label="Build output preview"><ArtifactPreview preview={snapshot.compositionPreview} empty={build ? "No visual output in this build." : "No build output to preview."} retry={() => { if (snapshot.compositionPreview.artifactRevisionId) void controller.previewCompositionOutput(snapshot.compositionPreview.artifactRevisionId); }} /></div></section>
