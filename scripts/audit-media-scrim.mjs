...
const MARKS = [
  ...
  { id: "social-nav", role: "glyph", source: "src/entities/unit/ui/UnitSocialPreview.tsx",
  ...
  { id: "social-count", role: "label", source: "src/entities/unit/ui/UnitSocialPreview.tsx",
  ...
  { id: "social-safe", role: "label", source: "src/entities/unit/ui/UnitSocialPreview.tsx",
  ...
  { id: "social-play", role: "glyph", source: "src/entities/unit/ui/UnitSocialPreview.tsx",
  ...
  { id: "social-duration", role: "label", source: "src/entities/unit/ui/UnitSocialPreview.tsx",
  ...
  { id: "asset-extension", role: "label", source: "src/entities/media/ui/VirtualAssetGrid.tsx",
    cls: "asset-extension type-image min-h-5 rounded-chip bg-media-plate px-1.75 type-xs text-on-instrument-muted",
    html: (c) => `<span class="${c}" data-mark>image</span>` },
  { id: "hero-copy", role: "label", source: "src/widgets/instrument-sidebar/ui/WorkspacePicker.tsx",
