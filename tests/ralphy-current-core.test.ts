...
const currentCoreCapabilities = [
  ...
  "feedback.list", "feedback.resolve", "generation.start", "locator.resolve", "media.list", "media.review",
  ...
  "publication.refresh", "repair.start", "run.cancel", "run.list", "run.objects", "run.results", "run.show",
  "session.end", "session.list", "session.show", "session.start", "system.hello",
  "transcription.start", "transform.start", "unit.list",
