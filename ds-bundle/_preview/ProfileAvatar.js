...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ProfileAvatar.tsx
  var ProfileAvatar_exports = {};
  __export(ProfileAvatar_exports, {
    Default: () => Default,
    DerivedFromLibraryPath: () => DerivedFromLibraryPath,
    Sizes: () => Sizes
  });
  init_define_import_meta_env();
  ...
  var Row = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: "var(--space-3)", alignItems: "center", flexWrap: "wrap" }, children });
  var Default = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: ROOT }) });
  var Sizes = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Row, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: ROOT, size: 20 }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: ROOT, size: 26 }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: ROOT, size: 36 }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: ROOT, size: 56 })
  ] });
  var DerivedFromLibraryPath = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { children: ["/Users/creator", "/Users/studio-ops", "/Users/dana", "/Volumes/Shared/ralphy"].map(
    (path) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { display: "grid", gap: "var(--space-2)", justifyItems: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ProfileAvatar, { rootPath: `${path}/Movies/ralphy`, size: 36 }),
  ...
  return __toCommonJS(ProfileAvatar_exports);
})();
