...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ReviewControls.tsx
  var ReviewControls_exports = {};
  __export(ReviewControls_exports, {
    Approved: () => Approved,
    Empty: () => Empty,
    NeedsWork: () => NeedsWork,
  ...
  var Column = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      className: "inspector",
      style: {
  ...
  var Empty = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ReviewControls, { onChange: noop }) });
  var Shortlisted = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ReviewControls, { annotation: shortlisted, onChange: noop }) });
  var NeedsWork = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ReviewControls, { annotation: needsWork, onChange: noop }) });
  var Approved = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ReviewControls, { annotation: approved, onChange: noop }) });
  return __toCommonJS(ReviewControls_exports);
})();
