...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ResizeHandle.tsx
  var ResizeHandle_exports = {};
  __export(ResizeHandle_exports, {
  ...
  var scaffold = `
.ds-split { position: relative; display: flex; height: 168px;
  border: 1px solid var(--line); border-radius: var(--radius-lg); overflow: hidden; }
.ds-split > .ds-pane { padding: var(--space-3); color: var(--fg-3);
  font: var(--text-sm)/var(--leading-snug) var(--font-sans); }
.ds-pane-a { width: 180px; background: var(--panel-solid); }
.ds-pane-b { flex: 1; background: var(--sunken); }
.ds-col-handle { position: absolute; top: 0; bottom: 0; left: 176px; width: 7px;
  cursor: col-resize; }
.ds-col-handle::after { top: 0; bottom: 0; left: 3px; width: 1px; }
.ds-stack { display: flex; flex-direction: column; height: 168px;
  border: 1px solid var(--line); border-radius: var(--radius-lg); overflow: hidden; }
.ds-row-handle { position: relative; width: 100%; height: 7px; flex: none;
  margin: -3px 0; cursor: row-resize; }
.ds-row-handle::after { top: 3px; right: 0; left: 0; height: 1px; }
.ds-hovered .panel-resize-handle::after { background: var(--line-strong); }
`;
  var Scaffold = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: scaffold });
  var ColumnSplit = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scaffold, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ds-split", style: { width: 420 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-a", children: "Sidebar" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-b", children: "Workbench" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ds_exports.ResizeHandle,
        {
  ...
  var RowSplit = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scaffold, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ds-stack", style: { width: 420 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-b", style: { flex: 1 }, children: "Asset grid" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ds_exports.ResizeHandle,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-a", style: { width: "100%", height: 64 }, children: "Bottom panel" })
    ] })
  ] });
  var HoverAffordance = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scaffold, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ds-split ds-hovered", style: { width: 420 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-a", children: "Sidebar" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-pane ds-pane-b", children: "Workbench — pointer over the divider" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ds_exports.ResizeHandle,
        {
          ariaLabel: "Resize sidebar",
  ...
  return __toCommonJS(ResizeHandle_exports);
})();
