...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/BottomPanel.tsx
  var BottomPanel_exports = {};
  __export(BottomPanel_exports, {
    Compact: () => Compact,
    Open: () => Open
  });
  init_define_import_meta_env();
  ...
  var Stage = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 620, background: "var(--canvas)", borderRadius: "var(--radius-lg)", overflow: "hidden" }, children });
  var Open = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stage, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.BottomPanel, { height: 260, visible: true, rootPath: ROOT }) });
  var Compact = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stage, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.BottomPanel, { height: 150, visible: true, rootPath: ROOT }) });
  return __toCommonJS(BottomPanel_exports);
})();
