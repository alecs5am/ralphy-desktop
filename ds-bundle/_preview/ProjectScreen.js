...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ProjectScreen.tsx
  var ProjectScreen_exports = {};
  __export(ProjectScreen_exports, {
    Indexed: () => Indexed,
    Indexing: () => Indexing
  });
  init_define_import_meta_env();
  ...
  var Indexed = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Screen, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.ProjectScreen,
    {
      project: projects[0],
      scan,
      annotations,
  ...
  var Indexing = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Screen, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.ProjectScreen,
    {
      project: projects[2],
      scan: null,
  ...
  return __toCommonJS(ProjectScreen_exports);
})();
