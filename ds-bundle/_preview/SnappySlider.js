...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/SnappySlider.tsx
  var SnappySlider_exports = {};
  __export(SnappySlider_exports, {
    Disabled: () => Disabled,
    Scrubber: () => Scrubber,
    Volume: () => Volume,
    WithSnapMarks: () => WithSnapMarks
  });
  init_define_import_meta_env();
  ...
  var Row = ({ label, children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gap: "var(--space-2)", width: 260 }, children: [
  ...
  var Volume = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { label: "volume — 0.72", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SnappySlider,
    {
      value: 0.72,
      min: 0,
      max: 1,
  ...
  var Scrubber = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { label: "playhead — 00:07 / 00:15", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SnappySlider,
    {
      value: 7.4,
      min: 0,
  ...
  var WithSnapMarks = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { label: "zoom — snap marks at 25 / 50 / 100 / 200 / 400 %", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SnappySlider,
    {
      value: 100,
      min: 25,
  ...
  var Disabled = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, { label: "playback rate — disabled", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SnappySlider,
    {
      value: 1,
      min: 0.25,
  ...
  return __toCommonJS(SnappySlider_exports);
})();
