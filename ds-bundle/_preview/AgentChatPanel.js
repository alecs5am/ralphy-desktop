...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/AgentChatPanel.tsx
  var AgentChatPanel_exports = {};
  __export(AgentChatPanel_exports, {
  ...
  var providers = [
    {
      ...
      connected: true,
      detail: "Signed in with claude.ai",
      defaultModel: "opus-5",
      models: [
        { id: "opus-5", label: "Opus 5", description: "Deepest reasoning" },
        { id: "sonnet-5", label: "Sonnet 5", description: "Balanced" }
      ]
    },
    {
      id: "codex",
      ...
      models: [{ id: "default", label: "Default", description: "Codex CLI default" }]
    },
    {
      id: "openrouter",
      label: "OpenRouter",
      ...
      models: [{ id: "openai/gpt-5.4", label: "GPT-5.4", description: "General purpose" }]
    }
  ];
  var transcript = [
    {
      id: 1,
      kind: "user",
      text: "Re-render the hook scene at 9:16 and keep the warm grade."
    },
    {
      id: 2,
      kind: "tool",
      tool: {
        id: "t1",
        name: "ralphy render",
        summary: "coffee-grinder-001 --slot hook",
        status: "complete"
      }
    },
    {
      id: 3,
      kind: "assistant",
      text: "Re-rendered `scene-01-hook` at **1080×1920** with the existing LUT.\n\n- Cost: $1.20 (kling-v3.0-pro)\n- Output: `artifacts/videos/scene-01-hook.mp4`\n\nThe specular highlight on the collar is still hot — worth a second pass if the client flags it."
    }
  ];
  function conversation(over = {}) {
    return {
      id: "chat-1",
      title: "Hook re-render",
      provider: "claude",
      model: "opus-5",
      entries: transcript,
      nextId: 4,
  ...
  function chatController(over = {}, chatOver = {}) {
    const active = conversation(chatOver);
    const noop2 = () => {
    };
    return {
      state: { chats: [active], activeChatId: active.id, runningChatId: null },
      activeChat: active,
      providers,
      ...
      setProvider: noop2,
      setModel: noop2,
      setClaudeAuthMethod: noop2,
      setPermissionMode: noop2,
      login: async () => {
      },
  ...
  var emptyChat = () => chatController({}, { entries: [], title: "New chat", lastCostUsd: null, sessionId: null });
  var runningChat = () => {
    const controller = chatController({}, { busy: true, streamingAssistantId: 3 });
    return {
      ...controller,
      state: { ...controller.state, runningChatId: controller.activeChat.id }
    };
  };
  var disconnectedChat = () => chatController({ connected: false, connectionError: "Ralphy CLI is not reachable" });
  ...
  var Panel = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      style: {
        width: 380,
  ...
  var Conversation = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AgentChatPanel,
    {
      chat: chatController(),
  ...
  var EmptyState = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AgentChatPanel,
    {
      chat: emptyChat(),
      workspace: workspaces[0],
  ...
  var Running = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AgentChatPanel,
    {
      chat: runningChat(),
      workspace: workspaces[0],
  ...
  var Disconnected = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Panel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AgentChatPanel,
    {
  ...
  return __toCommonJS(AgentChatPanel_exports);
})();
