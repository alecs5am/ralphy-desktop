...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/AssetTile.tsx
  var AssetTile_exports = {};
  __export(AssetTile_exports, {
    Kinds: () => Kinds,
  ...
  var row = {
    ...
    gap: 16,
    width: "var(--w, 208px)",
    "--asset-tile-height": "196px"
  };
  var Unreviewed = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: row, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AssetTile,
    {
      item: heroImage,
      selected: false,
      onSelect: noop,
  ...
  var Selected = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: row, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AssetTile,
    {
      item: finalRender,
      annotation: approved,
  ...
  var ReviewStates = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...row, "--cols": 3, "--w": "656px" }, children: [
  ...
  var Kinds = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...row, "--cols": 3, "--w": "656px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.AssetTile,
      {
        item: finalRender,
  ...
  return __toCommonJS(AssetTile_exports);
})();
