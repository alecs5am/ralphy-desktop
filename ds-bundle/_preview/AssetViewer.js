...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/AssetViewer.tsx
  var AssetViewer_exports = {};
  __export(AssetViewer_exports, {
    AudioTakeAtStart: () => AudioTakeAtStart,
    Document: () => Document
  });
  init_define_import_meta_env();
  ...
  var Document = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Screen, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AssetViewer,
    {
      item: briefDoc,
      project: projects[0],
  ...
  var AudioTakeAtStart = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Screen, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.AssetViewer,
    {
      item: voiceTrack,
      project: projects[0],
  ...
  return __toCommonJS(AssetViewer_exports);
})();
