...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/Inspector.tsx
  ...
  var Column = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 336, background: "var(--canvas)", borderRadius: "var(--radius-lg)", overflow: "hidden" }, children });
  var GeneratedArtifact = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.Inspector,
    {
      item: heroImage,
      project: projects[0],
  ...
  var WithoutPreview = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.Inspector,
    {
      item: heroImage,
      project: projects[0],
  ...
  var LifecycleDocument = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.Inspector,
    {
      item: briefDoc,
      project: projects[0],
  ...
  return __toCommonJS(Inspector_exports);
})();
