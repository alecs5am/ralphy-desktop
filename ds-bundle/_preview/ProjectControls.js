...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ProjectControls.tsx
  var ProjectControls_exports = {};
  __export(ProjectControls_exports, {
    Filtered: () => Filtered,
    Narrow: () => Narrow,
    Overview: () => Overview
  });
  ...
  var Bar = ({
    width = 760,
    children
  }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width }, children });
  var Overview = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.ProjectControls,
    {
      query,
      itemCount: 13,
      kindCounts,
  ...
  var Filtered = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.ProjectControls,
    {
      query: {
        ...query,
  ...
  var Narrow = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { width: 460, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.ProjectControls,
    {
  ...
  return __toCommonJS(ProjectControls_exports);
})();
