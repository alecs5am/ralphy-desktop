...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/InspectorPreview.tsx
  var InspectorPreview_exports = {};
  __export(InspectorPreview_exports, {
    AudioTake: () => AudioTake,
    Document: () => Document,
  ...
  var Column = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 320 }, children });
  var Document = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.InspectorPreview, { item: briefDoc, onOpen: noop }) });
  var AudioTake = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.InspectorPreview,
    {
      item: item("artifacts/audio/vo-take-03.wav", "generated-artifact", "audio", 418e4),
      onOpen: noop
    }
  ) });
  var PlainTextFile = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Column, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.InspectorPreview,
    {
      item: item("production-plan.json", "lifecycle-document", "text", 12480),
      onOpen: noop
    }
  ) });
  return __toCommonJS(InspectorPreview_exports);
})();
